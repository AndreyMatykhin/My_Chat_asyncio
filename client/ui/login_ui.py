...
class Ui_Login_Dialog(object):
    ...
    def retranslateUi(self, Login_Dialog):
        ...
        self.username_label.setText(_translate("Login_Dialog",
                                               "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Username</span></p></body></html>"))
        self.password_label.setText(_translate("Login_Dialog",
                                               "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Password</span></p></body></html>"))
